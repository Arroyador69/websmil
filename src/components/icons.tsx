export function IconPanel({ className = "h-6 w-6" }: { className?: string }) {
  return (
...
export function IconRocket({ className = "h-6 w-6" }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export const benefitIcons = [IconPanel, IconBolt, IconRocket, IconChart];
